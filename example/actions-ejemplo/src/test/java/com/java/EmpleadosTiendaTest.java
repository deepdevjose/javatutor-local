...
public class EmpleadosTiendaTest {
    ...
    public void testEncontrarVentaMaxima() {
        EmpleadosTienda.encontrarVentaMaxima(empleados);
    ...
    public void testAplicarIncremento() {
        EmpleadosTienda.aplicarIncremento(empleados);
        String output = outputContent.toString();
    ...
    public void testMostrarVentasMinimasDiciembre() {
        EmpleadosTienda.mostrarVentasMinimasDiciembre(empleados);
        String output = outputContent.toString();
