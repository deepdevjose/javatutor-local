...
public class PROBLEMA_4_14_PAG_291Test {
    ...
    public void testEncontrarMesMayorCostoDulces() {
        ...
        assertEquals(5, PROBLEMA_4_14_PAG_291.encontrarMesMayorCostoDulces(prod));
    }
    ...
    public void testCalcularPromedioAnualBebidas() {
        ...
        assertEquals(100.0, PROBLEMA_4_14_PAG_291.calcularPromedioAnualBebidas(prod), 0.01);
    }
    ...
    public void testEncontrarMesesExtremosBebidas() {
        ...
        int[] resultado = PROBLEMA_4_14_PAG_291.encontrarMesesExtremosBebidas(prod);
    ...
    public void testEncontrarDepartamentoMenorCostoDiciembre() {
        ...
        assertEquals(2, PROBLEMA_4_14_PAG_291.encontrarDepartamentoMenorCostoDiciembre(prod));
    }
    ...
    public void testMainOutput() {
        ...
        PROBLEMA_4_14_PAG_291.main(new String[]{});
