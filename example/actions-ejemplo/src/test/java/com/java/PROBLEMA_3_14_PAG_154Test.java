...
public class PROBLEMA_3_14_PAG_154Test {
    ...
    public void testProcesarVenta() {
        ...
        assertEquals(200.0, PROBLEMA_3_14_PAG_154.procesarVenta(1, 2, p1, p2, p3, p4, p5), 0.01);
        assertEquals(600.0, PROBLEMA_3_14_PAG_154.procesarVenta(2, 3, p1, p2, p3, p4, p5), 0.01);
        assertEquals(900.0, PROBLEMA_3_14_PAG_154.procesarVenta(3, 3, p1, p2, p3, p4, p5), 0.01);
        assertEquals(800.0, PROBLEMA_3_14_PAG_154.procesarVenta(4, 2, p1, p2, p3, p4, p5), 0.01);
        assertEquals(1500.0, PROBLEMA_3_14_PAG_154.procesarVenta(5, 3, p1, p2, p3, p4, p5), 0.01);
        
        // Probar venta con clave inválida
        assertEquals(0.0, PROBLEMA_3_14_PAG_154.procesarVenta(6, 2, p1, p2, p3, p4, p5), 0.01);
    }
    ...
    public void testMainOutput() {
        ...
        PROBLEMA_3_14_PAG_154.main(new String[]{});
