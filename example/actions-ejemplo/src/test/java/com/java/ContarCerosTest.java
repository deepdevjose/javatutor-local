...
public class ContarCerosTest {
    
    @Test
    public void testContarCeros() {
        // Prueba con array que contiene ceros
        int[] numeros1 = {0, 1, 0, 3, 0, 5};
        assertEquals(3, ContarCeros.contarCeros(numeros1));
        
        // Prueba con array sin ceros
        int[] numeros2 = {1, 2, 3, 4, 5};
        assertEquals(0, ContarCeros.contarCeros(numeros2));
        
        // Prueba con array vacío
        int[] numeros3 = {};
        assertEquals(0, ContarCeros.contarCeros(numeros3));
        
        // Prueba con array que solo tiene ceros
        int[] numeros4 = {0, 0, 0};
        assertEquals(3, ContarCeros.contarCeros(numeros4));
    }
